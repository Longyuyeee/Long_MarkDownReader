...
完整阶段审计、设计对齐和后续交错排期见 `docs/Development_Stage_Audit_2026-07-20.md`。当前工作区已完成 S6-8、T7-1、F7-1、S6-9、F7-2、S6-10～S6-15、G7-2、G7-3、I7-1、I7-2、W7-1～W7-3；统一对象、索引和专业管理工作台阶段已经收尾，下一入口为 S8-1 / FR-DATA-009。
...
17. 下一批 S8-1 / FR-DATA-009：补齐 XLSX 工作表行列插入、删除、隐藏和分组，升级 `sheet_structure` 公开矩阵与真实 fixture。
18. 完善 FR-BASE-005：增加关键保存流程 E2E、格式 fixture 和视觉回归门禁。
