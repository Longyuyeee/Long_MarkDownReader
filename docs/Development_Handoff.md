...
完整阶段审计、设计对齐和后续交错排期见 `docs/Development_Stage_Audit_2026-07-20.md`。当前工作区已完成 S6-8、T7-1、F7-1、S6-9、F7-2、S6-10～S6-15、G7-2、G7-3 与 I7-1；下一入口为 I7-2 / FR-INDEX-003。
...
13. 下一批 I7-2 / FR-INDEX-003：为快照增加 PDF 页/OCR 页搜索段，让跨格式搜索优先消费有效索引并保留实时扫描降级。
14. 完善 FR-BASE-005：增加关键保存流程 E2E、格式 fixture 和视觉回归门禁。
...
- OPML 主题、Canvas 节点、PDF 批注和 Table 视图已是全局图谱中的独立对象；本地索引支持持久化全量重建与签名失效检测，尚未实现文件级增量更新或索引化页级全文搜索。
