...
完整阶段审计、设计对齐和后续交错排期见 `docs/Development_Stage_Audit_2026-07-20.md`。当前工作区已完成 S6-8、T7-1、F7-1、S6-9、F7-2、S6-10～S6-15、G7-2 与 G7-3；下一入口为 I7-1 / FR-INDEX-002。
...
12. 下一批 I7-1 / FR-INDEX-002：建设可删除重建、带版本与进度、支持增量失效的本地索引，用户文件继续作为唯一事实源。
13. 完善 FR-BASE-005：增加关键保存流程 E2E、格式 fixture 和视觉回归门禁。
...
- OPML 主题、Canvas 节点、PDF 批注和 Table 视图已是全局图谱中的独立对象；当前索引仍按请求从文件全量重建，尚无持久化增量索引。
