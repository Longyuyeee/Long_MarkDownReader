...
> 2026-07-20 需求基线更新：本文保留为历史选型审计，但“完整引擎不进入主线”的产品结论已被 FR-DATA-009 取代。完整 Excel 等价编辑器现为主线目标；既有许可、离线、包体和往返风险继续作为实现约束。当前接口与 fixture 基线见 `Workbook_Engine_Interface.md`。
