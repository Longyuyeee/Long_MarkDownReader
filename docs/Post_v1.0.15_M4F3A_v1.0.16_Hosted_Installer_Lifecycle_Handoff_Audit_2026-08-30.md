...
首轮托管运行 `33264898797` 已从旧候选成功生成 MSI 与 NSIS，并由本地独立复核大小、SHA-256 和 `NotSigned`；随后 R5J 在工作台等待 M2A2 已移除的知识网络脉搏而失败，未进入路由/I/O。该运行只作为失败诊断历史，不计入发布门禁。实际用户入口和验收脚本已在 M4F-3B 纠偏，新产品候选为 `99cc4b79e13fc7fcc198da975b51880fc366afe4`，必须重新构建并执行完整生命周期。
