...
公开版本与运行时版本现均为 `1.0.18`，下一补丁目标登记为 `1.0.19`。唯一接续点为 **M6-8 v1.0.17→v1.0.18 官方应用内更新观察**：在一次性 Windows 上从公开 v1.0.17 安装，通过应用内受控更新发现并安装本次官方 NSIS，复核 SHA-256、覆盖安装、重启、最新版状态和资料保留。
