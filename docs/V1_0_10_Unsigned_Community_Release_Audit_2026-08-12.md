...
> **2026-08-15 更新链补录：** 官方 `v1.0.9 -> v1.0.10` 应用内更新已由 GitHub 托管运行 `31872858203` 完成 12/12 检查，自动重启和资料保留通过；证据已导入 `docs/evidence/v1.0.10-managed-updater/`。v1.0.10 社区发布链现已完整收口。
