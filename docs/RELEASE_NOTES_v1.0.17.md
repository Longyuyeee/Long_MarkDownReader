...
v1.0.17 Tag 已绑定精确产品提交 `2b6235d420ceffd291dab72c4af17caffe464333`，GitHub Release `379561360` 的 NSIS、MSI 与 `SHA256SUMS.txt` 已从公开地址重新下载并逐项复核。官方 v1.0.16→v1.0.17 应用内更新也由托管运行 `33368732235` 完成 12/12 检查，覆盖发现、确认、SHA-256、同目录覆盖、自动重启、最新版状态与资料保留。
