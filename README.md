...
开发进度：v1.0.22 已冻结为“搜索故障恢复 + 紧凑结果可读性”补丁，正在准备版本迁移与安装包验收，**尚未发布**。接续开发见 [范围与剩余步骤](docs/Post_v1.0.21_v1.0.22_Scope_Freeze_and_Readiness_2026-09-12.md)。下面下载仍为正式 v1.0.21。
