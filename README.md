...
> v1.0.20 正在准备发布：本补丁修复知识图谱缩放闪烁、拖动/打开混淆、密集节点视觉噪声和大图绘制开销。当前仍以 v1.0.19 为公开下载；v1.0.20 需完成双安装包、SHA-256、安装生命周期和自动更新边界复核后才会晋级。范围见 [v1.0.20 发布说明](docs/RELEASE_NOTES_v1.0.20.md)。
...
知识图谱把文件、标题、链接与 Canvas 节点组织成可交互网络。支持搜索、筛选、多种布局与主题、框选和拖动、缩放、适应当前选择、减少动效安全的节点聚焦、可点击/拖动/键盘操作的语义缩略导航、右键操作、中心节点、视图保存以及 SVG/PNG 导出。
