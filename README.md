...
<p align="center">
  <a href="https://github.com/Longyuyeee/Long_MarkDownReader/releases/tag/v1.0.20"><img src="https://img.shields.io/badge/Stable-v1.0.20-cca43b" alt="v1.0.20 stable"></a>
...
> v1.0.20 已正式发布并完成三个公开附件的回下载 SHA-256 复核。本补丁修复知识图谱缩放闪烁、拖动/打开混淆、布局稳定后未自动适配、密集箭头/状态环噪声和大图绘制开销，并加入有界且尊重减少动效设置的选择反馈。完整范围见 [v1.0.20 发布说明](docs/RELEASE_NOTES_v1.0.20.md)。

> v1.0.21 正在执行正式候选收口，尚未公开发布。该补丁进一步限制普通图谱的最小缩放，停止稳定布局后的无效连续帧，并将节点详情收为右下角卡片，统一顶部选择器且拉开三种画布主题差异。候选边界与真实验证基线见 [v1.0.21 发布说明](docs/RELEASE_NOTES_v1.0.21.md)。

## 下载

Long编辑 v1.0.20 支持 Windows 10/11 x64。

| 安装方式 | 下载 | 适用场景 |
| --- | --- | --- |
| NSIS 安装程序 | [LongEdit_1.0.20_x64-setup.exe](https://github.com/Longyuyeee/Long_MarkDownReader/releases/download/v1.0.20/LongEdit_1.0.20_x64-setup.exe) | 推荐，大多数用户 |
| MSI 安装程序 | [LongEdit_1.0.20_x64_zh-CN.msi](https://github.com/Longyuyeee/Long_MarkDownReader/releases/download/v1.0.20/LongEdit_1.0.20_x64_zh-CN.msi) | 管理部署或 MSI 工作流 |
| 校验与说明 | [Release v1.0.20](https://github.com/Longyuyeee/Long_MarkDownReader/releases/tag/v1.0.20) | Release Notes 与 SHA-256 |

社区版暂未使用 Authenticode 商业证书，Windows 可能显示“未知发布者”或 SmartScreen 提示。请只从本仓库的 GitHub Release 下载，并使用同页 `SHA256SUMS.txt` 核对文件。

```text
996e12218a24e1689947ec0c358720cc84cc136ffb2ac581fe31682fb8516582  LongEdit_1.0.19_x64-setup.exe
04aca041970120b0685cb1d30ee95e5102b6fdd60b59394f3ecac45a00b863f0  LongEdit_1.0.19_x64_zh-CN.msi
```

v1.0.5 是受控自动更新链的首个版本。v1.0.4 及更早版本需要手动安装 v1.0.5 或当前版本一次；之后应用可每 24 小时检查最新稳定 Release，也可在设置中手动检查。更新始终需要用户确认，并在安装前校验官方 NSIS 的大小与 SHA-256。v1.0.18 → v1.0.19 的发布后官方更新观察已由 [真实运行 33418123151](https://github.com/Longyuyeee/Long_MarkDownReader/actions/runs/33418123151) 以 12/12、失败 0 通过；v1.0.19 → v1.0.20 的真实覆盖安装和安装态生命周期已由 [运行 33461982887](https://github.com/Longyuyeee/Long_MarkDownReader/actions/runs/33461982887) 以 22/22、18/18、11/11、7/7、失败 0 通过，发布后的官方应用内更新观察仍作为下一阶段单独执行。
