...
当前公开及运行版本为 v1.0.22；安装态搜索、保存和生命周期验收已完成。官方 1.0.21 → 1.0.22 应用内更新观察仍待独立执行，不与安装验收混用。下一目标 [v1.0.23 用户任务计划](docs/V1_0_23_User_Task_Plan_2026-09-22.md)优先修复版本身份显示，尚未升版。
