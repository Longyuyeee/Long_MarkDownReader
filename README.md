...
```text
154ace58e2e20b6ebe9947c2690f03b0d9737f69fecb9ffca90c0cdf3b2ba282  LongEdit_1.0.17_x64-setup.exe
...
M6-5 [v1.0.18 托管安装生命周期](docs/Post_v1.0.17_M6_5_v1.0.18_Hosted_Installer_Lifecycle_Audit_2026-08-31.md) 已通过：GitHub 一次性 Windows 从精确候选重建 MSI/NSIS，并以公开 `v1.0.17` 完成 22/22 生命周期、18/18 安装态检查、11/11 路由和 7/7 管理回滚，失败 0；14 张截图已人工复核。当前唯一接续点是 M6-6 最终产物清单与发布就绪审计，完成前不会创建 `v1.0.18` Tag 或 Release。
