...
- 知识图谱 2.0 已完成稳定语义探索、密度感知语义缩放、社区轮廓、确定性曲线/平行关系、切线箭头、选中路径表达、适应选择和减少动效安全的有界聚焦；缩略导航、聚类镜头、全屏和大图性能仍按后续阶段推进。
...
知识图谱把文件、标题、链接与 Canvas 节点组织成可交互网络。支持搜索、筛选、多种布局与主题、框选和拖动、缩放、适应当前选择、减少动效安全的节点聚焦、右键操作、中心节点、视图保存以及 SVG/PNG 导出。
