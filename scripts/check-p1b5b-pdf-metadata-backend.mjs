...
if (!['P1-B5B', 'P1-B5C'].includes(metadata.stage) || !['backend-complete-workspace-pending', 'workspace-complete-desktop-evidence-pending'].includes(metadata.status) || metadata.currentWriteCapability !== ['P1-B5C'].includes(metadata.stage)) fail('P1-B5B metadata contract identity is stale')
...
if (!['P1-B5B', 'P1-B5C'].includes(advanced.stage) || !['metadata-backend-complete', 'metadata-workspace-complete'].includes(advanced.status) || advanced.currentCapabilities?.includes('metadata-copy') !== ['P1-B5C'].includes(advanced.stage)) fail('P1-B5B public capability boundary is stale')
