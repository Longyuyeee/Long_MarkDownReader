...
if (policy.selectedNextStage?.id !== 'M7-3' || development.currentStage !== 'M7-3-v1019-quality-debt-and-release-readiness-audit' || development.runtimeBaseVersion !== '1.0.18' || development.releaseCandidate) fail('M7-3 handoff drift')
