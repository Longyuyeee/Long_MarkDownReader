...
if (development.currentStage !== expectedDevelopmentStage || (m7Active && development.binaryVersionTransition !== 'v1.0.18-release-and-managed-updater-closed') || !['1.0.17', '1.0.18'].includes(development.runtimeBaseVersion)
