...
if (development.currentStage !== expectedDevelopmentStage || (laterStageActive && !['v1.0.18-release-and-managed-updater-closed', 'v1.0.19-quality-gate-pending', 'v1.0.19-candidate-packaged', 'v1.0.19-hosted-installer-lifecycle-passed', 'v1.0.19-release-ready', 'v1.0.19-public-release-published', 'v1.0.19-release-and-managed-updater-closed', 'v1.0.20-quality-gate-pending', 'v1.0.20-candidate-packaged', 'v1.0.20-hosted-installer-lifecycle-passed', 'v1.0.20-release-ready', 'v1.0.20-public-release-published', 'v1.0.20-release-and-managed-updater-closed'].includes(development.binaryVersionTransition)) || !['1.0.17', '1.0.18', '1.0.19', '1.0.20'].includes(development.runtimeBaseVersion)
  || !['1.0.17', '1.0.18', '1.0.19', '1.0.20'].includes(development.publicVersion) || !['1.0.18', '1.0.19', '1.0.20', '1.0.21'].includes(development.developmentTargetVersion) || development.releaseCandidate) fail('M6-3 handoff drift')
