...
if ((!laterPublicActive && (development.publicVersion !== '1.0.18' || development.publicTag !== policy.tag || development.publicTagCommit !== policy.candidateSourceCommit))
  || !['1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22'].includes(development.runtimeBaseVersion) || development.developmentTargetVersion !== (laterPublicActive ? `1.0.${Number(development.publicVersion.split('.')[2]) + 1}` : '1.0.19')
