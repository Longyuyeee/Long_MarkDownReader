...
if (policy.productSourceCommit !== null || policy.hostedRunId !== null || policy.expectedEvidenceFiles.length !== 3) failures.push('G15E pending installed evidence identity drift')
