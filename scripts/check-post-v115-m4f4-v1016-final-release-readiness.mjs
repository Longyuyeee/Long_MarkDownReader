...
if (published) {
  ...
  const expectedPublicVersion = ['1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22'].includes(development.publicVersion) ? development.publicVersion : m5Published?.status === 'published-and-remote-assets-verified' ? '1.0.17' : '1.0.16'
  if (development.currentStage !== expectedStage || (postClosureStage && !/^M[678]-[0-9]+-/.test(development.currentStage)) || !(['v1.0.16-public-release-published', 'v1.0.17-quality-gate-pending', 'v1.0.17-candidate-packaged', 'v1.0.17-hosted-lifecycle-passed', 'v1.0.17-release-ready', 'v1.0.17-public-release-published', 'v1.0.17-release-and-managed-updater-closed'].includes(development.binaryVersionTransition) || development.binaryVersionTransition.startsWith('v1.0.18-') || development.binaryVersionTransition.startsWith('v1.0.19-') || development.binaryVersionTransition.startsWith('v1.0.20-') || (development.binaryVersionTransition.startsWith('v1.0.21-') || (development.binaryVersionTransition.startsWith('v1.0.22-') || development.binaryVersionTransition === 'v1.0.23-quality-gate-pending'))) || development.publicVersion !== expectedPublicVersion || development.publicTag !== `v${expectedPublicVersion}`) fail('published development/public handoff drifted')
