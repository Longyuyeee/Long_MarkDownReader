...
if (published) {
  ...
  const expectedPublicVersion = ['1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.publicVersion) ? development.publicVersion : m5Published?.status === 'published-and-remote-assets-verified' ? '1.0.17' : '1.0.16'
