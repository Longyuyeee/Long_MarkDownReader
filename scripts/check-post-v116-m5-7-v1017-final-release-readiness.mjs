...
if (!(releaseClosed ? /^M[678]-[0-9]+-/.test(development.currentStage) : development.currentStage === (releasePublished ? 'M5-9-v1.0.16-to-v1.0.17-managed-updater-observation' : 'M5-8-v1.0.17-tag-release-and-remote-asset-verification'))
  ...
  || !(laterCandidateActive ? ['1.0.17', '1.0.18', '1.0.19', '1.0.20', '1.0.21'].includes(development.publicVersion) : development.publicVersion === (laterPublicActive ? development.runtimeBaseVersion : releasePublished ? '1.0.17' : '1.0.16'))) fail('development ready handoff drifted')
