...
const runtimeAccepted = laterStageActive ? ['1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.runtimeBaseVersion) : ['atomic-transition-complete-package-pending', 'accepted'].includes(successor.status) ? development.runtimeBaseVersion === '1.0.18' : development.runtimeBaseVersion === '1.0.17'
...
if (development.currentStage !== expectedDevelopmentStage || (laterStageActive && !development.binaryVersionTransition.startsWith(`v${development.runtimeBaseVersion}-`)) || !runtimeAccepted
  || !['1.0.17', '1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.publicVersion) || !['1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23', '1.0.24'].includes(development.developmentTargetVersion) || development.releaseCandidate) fail('M6-4 development handoff drift')
