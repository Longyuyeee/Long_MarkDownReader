...
const runtimeAccepted = laterStageActive ? ['1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22'].includes(development.runtimeBaseVersion) : ['atomic-transition-complete-package-pending', 'accepted'].includes(successor.status) ? development.runtimeBaseVersion === '1.0.18' : development.runtimeBaseVersion === '1.0.17'
