...
if (policy.selectedNextStage?.id !== 'M7-2' || !/^M[78]-(?:[2-9]|[1-9]\d)-/.test(development.currentStage) || !['1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.runtimeBaseVersion) || development.releaseCandidate) fail('M7-2 successor handoff drift')
