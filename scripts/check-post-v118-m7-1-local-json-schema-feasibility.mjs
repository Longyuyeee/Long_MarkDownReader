...
if (policy.selectedNextStage?.id !== 'M7-2' || !['M7-2-bounded-local-json-schema-product-implementation-and-real-desktop-audit', 'M7-3-v1019-quality-debt-and-release-readiness-audit'].includes(development.currentStage) || development.runtimeBaseVersion !== '1.0.18' || development.releaseCandidate) fail('M7-2 handoff drift')
