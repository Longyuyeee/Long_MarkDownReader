...
if (policy.selectedNextStage?.id !== 'M7-2' || !/^M7-(?:[2-9]|[1-9]\d)-/.test(development.currentStage) || development.runtimeBaseVersion !== '1.0.18' || development.releaseCandidate) fail('M7-2 successor handoff drift')
