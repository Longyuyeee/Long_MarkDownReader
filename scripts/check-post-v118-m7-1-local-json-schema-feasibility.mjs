...
if (policy.selectedNextStage?.id !== 'M7-2' || !/^M7-(?:[2-9]|[1-9]\d)-/.test(development.currentStage) || !['1.0.18', '1.0.19'].includes(development.runtimeBaseVersion) || development.releaseCandidate) fail('M7-2 successor handoff drift')
