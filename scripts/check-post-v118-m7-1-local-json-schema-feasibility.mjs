...
if (policy.selectedNextStage?.id !== 'M7-2' || development.currentStage !== 'M7-2-bounded-local-json-schema-product-implementation-and-real-desktop-audit' || development.runtimeBaseVersion !== '1.0.18' || development.releaseCandidate) fail('M7-2 handoff drift')
