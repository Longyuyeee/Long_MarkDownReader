...
if (policy.publicVersion !== '1.0.15' || evidence.publicVersion !== '1.0.15' || !['1.0.15', '1.0.16', '1.0.17', '1.0.18', '1.0.19', '1.0.20', '1.0.21'].includes(development.publicVersion) || development.publicTag !== `v${development.publicVersion}`) failures.push('public release boundary drifted')
