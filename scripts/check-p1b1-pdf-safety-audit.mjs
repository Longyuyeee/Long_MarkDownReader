...
if (!['P1-B1', 'P1-B2B1', 'P1-B2B2', 'P1-B2B3', 'P1-B2B4', 'P1-B2B5', 'P1-B2B6', 'P1-B3A'].includes(contract.stage) || !['audit-complete', 'text-form-copy-backend-complete', 'text-form-copy-workspace-complete', 'unicode-text-form-copy-complete', 'checkbox-form-copy-complete', 'radio-form-copy-complete', 'single-choice-form-copy-complete', 'permanent-redaction-safety-audit-complete'].includes(contract.status) || contract.plannedSlices?.length !== 5) fail('P1-B1 contract lineage is incomplete')
