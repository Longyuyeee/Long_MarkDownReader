...
if (!['P1-B1', 'P1-B2B1'].includes(contract.stage) || !['audit-complete', 'text-form-copy-backend-complete'].includes(contract.status) || contract.plannedSlices?.length !== 5) fail('P1-B1 contract lineage is incomplete')
