...
if (contract.stage !== 'P1-B2B6' || contract.status !== 'single-choice-form-copy-complete' || !contract.currentCapabilities?.includes('bounded-single-choice-form-copy')) fail('P1-B2B6 contract is stale')
