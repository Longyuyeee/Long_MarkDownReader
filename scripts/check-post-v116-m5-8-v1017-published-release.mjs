...
if (development.publicVersion !== '1.0.17' || development.publicTag !== policy.tag || development.publicTagCommit !== policy.candidateSourceCommit || !['1.0.17', '1.0.18'].includes(development.runtimeBaseVersion) || development.developmentTargetVersion !== '1.0.18' || !(updaterComplete ? /^M6-[0-9]+-/.test(development.currentStage) : development.currentStage === 'M5-9-v1.0.16-to-v1.0.17-managed-updater-observation') || !(updaterComplete ? ['v1.0.17-release-and-managed-updater-closed', 'v1.0.18-quality-gate-pending', 'v1.0.18-candidate-packaged', 'v1.0.18-hosted-installer-lifecycle-passed'].includes(development.binaryVersionTransition) : development.binaryVersionTransition === 'v1.0.17-public-release-published')) fail('development/public handoff drifted')
