...
const laterCandidateActive = ['1.0.19', '1.0.20', '1.0.21', '1.0.22'].includes(pkg.version) && community.appVersion === pkg.version && /^M[78]-(?:[4-9]|[1-9]\d)-/.test(development.currentStage)
...
if (!['1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22'].includes(development.runtimeBaseVersion) || development.publicVersion !== (laterPublicActive ? development.publicVersion : releasePublished ? '1.0.18' : '1.0.17')
