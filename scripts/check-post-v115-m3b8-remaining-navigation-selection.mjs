...
else for (const absent of ['data-testid="graph-fullscreen"', 'requestFullscreen()']) requireFact(!graphView.includes(absent), `M3B-8 current capability fact drifted: ${absent}`)
requireFact(!graphView.includes('data-testid="graph-cluster-collapse"'), 'M3B-8 cluster-collapse boundary drifted')
