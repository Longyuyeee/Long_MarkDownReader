...
if (!/^M[78]-(?:[4-9]|[1-9]\d)-/.test(development.currentStage) || !['1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.runtimeBaseVersion) || (!publishedSuccessor && (development.publicVersion !== '1.0.18' || development.developmentTargetVersion !== '1.0.19')) || development.releaseCandidate) fail('M7-4+ development handoff drift')
