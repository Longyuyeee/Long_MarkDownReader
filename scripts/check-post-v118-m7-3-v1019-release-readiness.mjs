...
if (development.currentStage !== 'M7-4-v1019-atomic-version-transition-and-candidate-packaging' || development.runtimeBaseVersion !== '1.0.18' || development.publicVersion !== '1.0.18' || development.developmentTargetVersion !== '1.0.19' || development.releaseCandidate) fail('M7-4 development handoff drift')
