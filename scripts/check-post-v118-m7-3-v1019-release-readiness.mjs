...
if (!/^M7-[4-9]-/.test(development.currentStage) || development.runtimeBaseVersion !== '1.0.19' || (!publishedSuccessor && (development.publicVersion !== '1.0.18' || development.developmentTargetVersion !== '1.0.19')) || development.releaseCandidate) fail('M7-4+ development handoff drift')
