...
if (!/^M7-[4-9]-v1\.0\.19-/.test(development.currentStage) || development.runtimeBaseVersion !== '1.0.19' || development.publicVersion !== '1.0.18' || development.developmentTargetVersion !== '1.0.19' || development.releaseCandidate) fail('M7-4+ development handoff drift')
