...
if (!graph.productIntegration?.graphHealthPanelVisible || graph.productIntegration?.workspaceHomeVisible !== false || !graph.productIntegration?.centeredGraphNavigation || !crossFormatGraph.qualityGate?.representativeCrossFormatPulseComplete) fail('P1 knowledge graph presence is incomplete')
