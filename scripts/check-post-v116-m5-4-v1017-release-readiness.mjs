...
if (![expectedDevelopmentStage, 'M5-7-v1.0.17-final-artifact-manifest-and-release-readiness-audit', 'M5-8-v1.0.17-tag-release-and-remote-asset-verification', 'M5-9-v1.0.16-to-v1.0.17-managed-updater-observation'].includes(development.currentStage)) fail('development handoff is not aligned with M5-5 progression')
