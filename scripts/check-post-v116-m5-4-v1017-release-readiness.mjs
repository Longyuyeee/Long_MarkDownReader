...
if (![expectedDevelopmentStage, 'M5-7-v1.0.17-final-artifact-manifest-and-release-readiness-audit', 'M5-8-v1.0.17-tag-release-and-remote-asset-verification', 'M5-9-v1.0.16-to-v1.0.17-managed-updater-observation', 'M6-0-v1.0.18-scope-selection-audit', 'M6-1-knowledge-graph-bounded-fullscreen-lifecycle-and-real-desktop-audit', 'M6-2-v1.0.18-next-slice-selection-audit'].includes(development.currentStage)) fail('development handoff is not aligned with M5-5 progression')
