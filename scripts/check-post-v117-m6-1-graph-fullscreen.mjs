...
if (!developmentStageAccepted || !['1.0.17', '1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.runtimeBaseVersion)
  || !['1.0.17', '1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22'].includes(development.publicVersion) || !['1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.developmentTargetVersion) || development.releaseCandidate) fail('M6-2 handoff drift')
