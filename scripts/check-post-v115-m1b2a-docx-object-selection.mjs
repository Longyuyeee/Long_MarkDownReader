...
const canonicalEvidenceBytes = Buffer.from(evidenceBytes.toString('utf8').replaceAll('\r\n', '\n'))
...
requireFact(manifest.evidenceSha256 === crypto.createHash('sha256').update(canonicalEvidenceBytes).digest('hex'), 'M1B2A evidence digest mismatch')
