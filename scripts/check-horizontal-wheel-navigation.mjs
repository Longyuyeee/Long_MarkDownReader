...
for (const [file, selector] of [
  ...
  ['src/views/MindMapView.vue', 'class="mindmap-toolbar" data-command-strip data-horizontal-wheel="always"'],
  ['src/views/CanvasView.vue', 'class="canvas-toolbar" role="toolbar" aria-label="Canvas 工具栏" data-command-strip data-horizontal-wheel="always"'],
  ...
  ['src/views/TableView.vue', 'class="table-tools" data-command-strip data-horizontal-wheel="always"'],
