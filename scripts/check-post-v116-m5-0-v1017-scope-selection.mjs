...
const publicProgression = (development.publicVersion === '1.0.16' && development.developmentTargetVersion === '1.0.17') || (development.publicVersion === '1.0.17' && development.developmentTargetVersion === '1.0.18') || (development.publicVersion === '1.0.18' && development.developmentTargetVersion === '1.0.19') || (development.publicVersion === '1.0.19' && development.developmentTargetVersion === '1.0.20') || (development.publicVersion === '1.0.20' && development.developmentTargetVersion === '1.0.21') || (development.publicVersion === '1.0.21' && development.developmentTargetVersion === '1.0.22') || (development.publicVersion === '1.0.22' && development.developmentTargetVersion === '1.0.23') || (development.publicVersion === '1.0.23' && development.developmentTargetVersion === '1.0.24')
if (!(['M5-1-odp-slide-text-producer-fidelity-and-object-selection', 'M5-2-odp-simple-slide-body-reliable-copy-foundation', 'M5-3-odp-simple-slide-body-copy-workspace-and-real-desktop-audit', 'M5-4-v1.0.17-quality-debt-and-release-readiness', 'M5-5-v1.0.17-atomic-version-transition-and-candidate-packaging', 'M5-6-v1.0.17-hosted-installer-lifecycle', 'M5-7-v1.0.17-final-artifact-manifest-and-release-readiness-audit', 'M5-8-v1.0.17-tag-release-and-remote-asset-verification', 'M5-9-v1.0.16-to-v1.0.17-managed-updater-observation'].includes(development.currentStage) || /^M[678]-[0-9]+-/.test(development.currentStage))
  || !['1.0.16', '1.0.17', '1.0.18', '1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.runtimeBaseVersion) || !publicProgression) fail('M5-1 development handoff drift')
