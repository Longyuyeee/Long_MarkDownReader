...
if (!['P1-B2B3', 'P1-B2B4', 'P1-B2B5', 'P1-B2B6', 'P1-B3A', 'P1-B3B', 'P1-B3C', 'P1-B3D', 'P1-B4A', 'P1-B4B', 'P1-B4C', 'P1-B4D', 'P1-B5A'].includes(contract.stage) || !['unicode-text-form-copy-complete', 'checkbox-form-copy-complete', 'radio-form-copy-complete', 'single-choice-form-copy-complete', 'permanent-redaction-safety-audit-complete', 'permanent-redaction-backend-complete', 'permanent-redaction-workspace-complete', 'permanent-redaction-complete', 'watermark-safety-audit-complete', 'watermark-backend-complete', 'watermark-workspace-complete', 'watermark-complete', 'metadata-safety-audit-complete'].includes(contract.status)) fail('P1-B2B3 contract lineage is stale')
