...
if (!['P1-B2B3', 'P1-B2B4'].includes(contract.stage) || !['unicode-text-form-copy-complete', 'checkbox-form-copy-complete'].includes(contract.status)) fail('P1-B2B3 contract lineage is stale')
