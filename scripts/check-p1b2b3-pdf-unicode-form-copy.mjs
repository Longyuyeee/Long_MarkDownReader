...
if (!['P1-B2B3', 'P1-B2B4', 'P1-B2B5', 'P1-B2B6'].includes(contract.stage) || !['unicode-text-form-copy-complete', 'checkbox-form-copy-complete', 'radio-form-copy-complete', 'single-choice-form-copy-complete'].includes(contract.status)) fail('P1-B2B3 contract lineage is stale')
