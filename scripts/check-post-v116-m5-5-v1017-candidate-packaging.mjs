...
const laterCandidateActive = ['1.0.18', '1.0.19', '1.0.20', '1.0.21'].includes(pkg.version) && community.appVersion === pkg.version && /^M[678]-[0-9]+-/.test(development.currentStage)
...
if (!['1.0.17', '1.0.18', '1.0.19', '1.0.20', '1.0.21'].includes(development.runtimeBaseVersion)
