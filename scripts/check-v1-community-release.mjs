...
if (policy.updater?.enabled !== true || policy.updater?.integritySignatureRequired !== true || policy.updater?.privateKeyCommitted !== false) fail('V1 updater trust policy drift')
