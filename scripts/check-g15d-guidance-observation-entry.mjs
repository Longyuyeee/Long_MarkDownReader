...
for (const token of ['waitForStableVisibleSurface', "document.querySelector('.page-loader')", 'visualSurfaceSettled: true', 'workspace knowledge observation entry', 'workspaceObservationNavigation', 'graph knowledge outcome entry', 'graphOutcomeNavigation', "exportTriggered: false", "id: 'installed-knowledge-observation-entry-navigation'", ...policy.expectedEvidenceFiles]) requireText(capture, token, `G15D installed navigation runner missing: ${token}`)
