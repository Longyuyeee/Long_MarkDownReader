...
if (community.appVersion !== '1.0.19' || community.currentStatus !== 'v1.0.19-community-release-quality-gate-pending' || community.patchValidation?.previousPublicVersion !== '1.0.18' || community.patchValidation?.managedUpdaterUpgradePath !== '1.0.18-to-1.0.19-pending' || community.targetRelease?.tag !== 'v1.0.19' || community.candidate !== null || community.release !== null || Object.values(community.gates ?? {}).some(Boolean)) fail('community pending candidate identity drift')
if (!notes.includes('状态：候选准备中，尚未公开发布') || !notes.includes('本地 JSON Schema') || !notes.includes('NotSigned') || !notes.includes('安装生命周期')) fail('v1.0.19 release notes boundary drift')
