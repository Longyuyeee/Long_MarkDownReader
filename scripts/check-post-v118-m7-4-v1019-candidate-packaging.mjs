...
if (development.runtimeBaseVersion !== '1.0.19' || (!publishedSuccessor && (development.publicVersion !== '1.0.18' || development.publicTag !== 'v1.0.18' || development.developmentTargetVersion !== '1.0.19')) || development.releaseCandidate) fail('development candidate/public split drift')
if (community.appVersion !== '1.0.19' || community.patchValidation?.previousPublicVersion !== '1.0.18' || community.targetRelease?.tag !== 'v1.0.19' || (publishedSuccessor ? community.release?.taggedCommit !== policy.candidateSourceCommit : community.release !== null)) fail('community candidate identity drift')
