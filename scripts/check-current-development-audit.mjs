...
const required = [
  ...
  [`当前开发目标：\`${development.developmentTargetVersion}\``, development.developmentTargetVersion === '1.0.19'],
  ...
  ['当前阶段：**M7-6 v1.0.19 最终制品清单与发布就绪审计**', policy.currentStatus === 'v1.0.19-community-release-hosted-lifecycle-passed-final-release-audit-pending' && policy.patchValidation?.managedUpdaterUpgradePath === '1.0.18-to-1.0.19-passed'],
]
