...
const required = [
  ...
  ['当前阶段：**M7-7 v1.0.19 Tag、Release 与远端附件复核**', policy.currentStatus === 'v1.0.19-community-release-ready-to-publish' && policy.patchValidation?.managedUpdaterUpgradePath === '1.0.18-to-1.0.19-passed'],
]
