...
const required = [
  ...
  ['当前阶段：**M7-8 v1.0.18 → v1.0.19 官方应用内更新观察**', policy.currentStatus === 'v1.0.19-community-release-published' && policy.patchValidation?.managedUpdaterUpgradePath === '1.0.18-to-1.0.19-passed'],
]
