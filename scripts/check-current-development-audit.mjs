...
const required = [
  ...
  ['当前阶段：**M6-6 v1.0.18 最终产物清单与发布就绪审计**', policy.currentStatus === 'v1.0.18-community-release-hosted-lifecycle-passed-final-release-audit-pending' && policy.patchValidation?.managedUpdaterUpgradePath === '1.0.17-to-1.0.18-passed'],
]
