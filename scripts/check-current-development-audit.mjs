...
execFileSync(process.execPath, ['--test', 'scripts/test-community-release-observation.mjs'], { stdio: 'inherit' })
...
const required = [
  ...
  [`当前开发目标：\`${development.developmentTargetVersion}\``, development.developmentTargetVersion === (v122Published ? '1.0.23' : '1.0.22')],
