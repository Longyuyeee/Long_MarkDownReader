...
const required = [
  ...
  ['当前阶段：**M6-3 v1.0.18 质量债与发布就绪审计**', policy.currentStatus === 'v1.0.17-community-release-published' && policy.patchValidation?.managedUpdaterUpgradePath === '1.0.16-to-1.0.17-passed'],
]
