...
const required = [
  ...
  ['当前阶段：**M7-1 本地 JSON Schema sidecar provider/mapping 可行性审计**', policy.currentStatus === 'v1.0.18-community-release-published' && policy.patchValidation?.managedUpdaterUpgradePath === '1.0.17-to-1.0.18-passed'],
]
