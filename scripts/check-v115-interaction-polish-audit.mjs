...
if (!evidence.dropdownLight?.visible || evidence.dropdownLight?.borderRadius === '0px' || evidence.dropdownLight?.boxShadow === 'none' || evidence.dropdownLight?.height > 520 || evidence.dropdownLight?.bottom > evidence.dropdownLight?.viewportHeight + 1) fail('light dropdown surface or viewport bounds are not accepted')
...
if (!evidence.dropdownDarkNarrow?.visible || evidence.dropdownDarkNarrow?.right > evidence.dropdownDarkNarrow?.viewportWidth + 1 || evidence.dropdownDarkNarrow?.bottom > evidence.dropdownDarkNarrow?.viewportHeight + 1 || evidence.dropdownDarkNarrow?.height > 520) fail('dark narrow dropdown bounds are not accepted')
