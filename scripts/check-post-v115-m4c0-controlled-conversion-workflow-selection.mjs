...
if (policy.selectedNextStage?.id !== successor.stage || successor.predecessor !== policy.stage || successor.selectedNextStage?.id !== 'M4C-2' || development.currentStage !== 'M4C-2-opml-canvas-projection-disclosure') failures.push('M4C successor handoff is not aligned')
