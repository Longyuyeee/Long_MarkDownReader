...
if (policy.selectedNextStage?.id !== successor.stage || successor.predecessor !== policy.stage || successor.selectedNextStage?.id !== opmlProjection.stage || opmlProjection.predecessor !== successor.stage || opmlProjection.selectedNextStage?.id !== graphOutputSelection.stage || graphOutputSelection.predecessor !== opmlProjection.stage || development.currentStage !== `${graphOutputSelection.selection.id}-${graphOutputSelection.selection.name}`) failures.push('M4C successor handoff is not aligned')
