...
if (!['P1-B2B1', 'P1-B2B2'].includes(contract.stage) || !['text-form-copy-backend-complete', 'text-form-copy-workspace-complete'].includes(contract.status)) fail('P1-B2B1 contract lineage is stale')
