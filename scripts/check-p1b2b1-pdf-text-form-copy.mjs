...
if (!['P1-B2B1', 'P1-B2B2', 'P1-B2B3', 'P1-B2B4', 'P1-B2B5', 'P1-B2B6'].includes(contract.stage) || !['text-form-copy-backend-complete', 'text-form-copy-workspace-complete', 'unicode-text-form-copy-complete', 'checkbox-form-copy-complete', 'radio-form-copy-complete', 'single-choice-form-copy-complete'].includes(contract.status)) fail('P1-B2B1 contract lineage is stale')
