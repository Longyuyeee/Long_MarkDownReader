...
if (policy.selectedNextStage?.id !== 'M4C-3' || development.currentStage !== 'M4C-3-graph-derived-output-disclosure-selection') failures.push('M4C-3 handoff is not aligned')
