...
const laterStageActive = managedUpdaterComplete && /^M[78]-[0-9]+-/.test(development.currentStage)
const expectedDevelopmentStage = laterStageActive
...
const expectedVersionTransition = laterStageActive
