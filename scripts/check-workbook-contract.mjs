...
if (pivotExcelEvidenceHandoff.requiredBundleMembers?.join(',') !== 'manifest.json,producer.json,s8-7e3g-microsoft-excel.xlsx' || pivotExcelEvidenceHandoff.trustedMachineConfirmationRequired !== true || pivotExcelEvidenceHandoff.baselineDigestBound !== true || pivotExcelEvidenceHandoff.longEditSemanticReparseRequired !== true || pivotExcelEvidenceHandoff.existingEvidenceOverwrite !== 'blocked') fail('S8-7E3G-D Excel evidence handoff boundary drift')
