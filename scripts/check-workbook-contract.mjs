...
if (!pivotMultiLevelAxisProducerRoundTrip || pivotMultiLevelAxisProducerRoundTrip.stage !== 'S8-7E3G' || pivotMultiLevelAxisProducerRoundTrip.execution !== 'producer_roundtrip_preflight' || pivotMultiLevelAxisProducerRoundTrip.status !== 'blocked_preflight') fail('S8-7E3G multi-axis producer preflight policy drift')
...
if (pivotMultiLevelAxisProducerRoundTrip.requiredProducerIds?.join(',') !== 'microsoft-excel,wps-spreadsheets,libreoffice-calc' || pivotMultiLevelAxisProducerRoundTrip.verifiedProducerCount !== 0 || pivotMultiLevelAxisProducerRoundTrip.requiredProducerCount !== 3) fail('S8-7E3G producer matrix boundary drift')
if (pivotMultiLevelAxisProducerRoundTrip.producerRoundTrip !== 'pending_environment' || pivotMultiLevelAxisProducerRoundTrip.reliableCopySave !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.writesUserFile !== false || pivotMultiLevelAxisProducerRoundTrip.sourceOverwrite !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.existingTargetOverwrite !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.pageFields !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.externalData !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.slicers !== 'blocked') fail('S8-7E3G release boundary drift')
