...
if (pivotMultiLevelAxisProducerRoundTrip.requiredProducerIds?.join(',') !== 'microsoft-excel,wps-spreadsheets,libreoffice-calc' || pivotMultiLevelAxisProducerRoundTrip.verifiedProducerIds?.join(',') !== 'wps-spreadsheets' || pivotMultiLevelAxisProducerRoundTrip.verifiedProducerCount !== 1 || pivotMultiLevelAxisProducerRoundTrip.requiredProducerCount !== 3) fail('S8-7E3G producer matrix boundary drift')
if (pivotMultiLevelAxisProducerRoundTrip.producerRoundTrip !== 'partial_1_of_3' || pivotMultiLevelAxisProducerRoundTrip.reliableCopySave !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.writesUserFile !== false || pivotMultiLevelAxisProducerRoundTrip.sourceOverwrite !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.existingTargetOverwrite !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.pageFields !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.externalData !== 'blocked' || pivotMultiLevelAxisProducerRoundTrip.slicers !== 'blocked') fail('S8-7E3G release boundary drift')
