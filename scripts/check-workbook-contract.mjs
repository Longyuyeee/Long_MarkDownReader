...
if (!arrayRead || arrayRead.stage !== 'X3-B4' || arrayRead.status !== 'partial_producer_matrix' || arrayRead.calculationPolicy !== 'blocked' || arrayRead.contentWritePolicy !== 'blocked-inside-declared-range' || arrayRead.structureWritePolicy !== 'blocked-on-containing-sheet') fail('X3-B4 array read boundary drift')
if (arrayRead.maxFormulasPerSheet !== 1024 || arrayRead.maxDeclaredCellsPerSheet !== 1000000 || !arrayRead.realOfficeProducerEvidence || arrayRead.fullProducerMatrixVerified !== false || arrayRead.verifiedProducerCount !== 1 || arrayRead.requiredProducerCount !== 3) fail('X3-B4 array resource/evidence boundary drift')
...
if (arrayProducerMatrix.stage !== 'X3-B2' || arrayProducerMatrix.status !== 'partial' || arrayProducerMatrix.verifiedProducers !== 1 || arrayProducerMatrix.requiredProducers !== 3) fail('X3-B2 producer matrix drift')
