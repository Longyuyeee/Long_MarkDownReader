...
const publishedSuccessor = ['1.0.19', '1.0.20', '1.0.21', '1.0.22'].includes(development.publicVersion) && development.developmentTargetVersion === `1.0.${Number(development.publicVersion.split('.')[2]) + 1}`
