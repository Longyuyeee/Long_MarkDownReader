...
if (development.runtimeBaseVersion !== '1.0.18' || development.publicVersion !== '1.0.18' || development.developmentTargetVersion !== '1.0.19' || !['M7-1-local-json-schema-sidecar-provider-mapping-feasibility-audit', 'M7-2-bounded-local-json-schema-product-implementation-and-real-desktop-audit'].includes(development.currentStage) || development.binaryVersionTransition !== 'v1.0.18-release-and-managed-updater-closed' || development.releaseCandidate) fail('M7-1/M7-2 development handoff drift')
