...
if (development.runtimeBaseVersion !== (candidateTransition ? '1.0.19' : '1.0.18') || development.publicVersion !== '1.0.18' || development.developmentTargetVersion !== '1.0.19' || !/^M7-(?:[1-9]|[1-9]\d)-/.test(development.currentStage) || (candidateTransition ? !development.binaryVersionTransition.startsWith('v1.0.19-') : development.binaryVersionTransition !== 'v1.0.18-release-and-managed-updater-closed') || development.releaseCandidate) fail('M7 successor development handoff drift')
