...
const publishedSuccessor = ['1.0.19', '1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.publicVersion) && development.developmentTargetVersion === `1.0.${Number(development.publicVersion.split('.')[2]) + 1}`
const successorRuntimeAccepted = successorTransition && ['1.0.20', '1.0.21', '1.0.22', '1.0.23'].includes(development.runtimeBaseVersion)
if (!(successorRuntimeAccepted || development.runtimeBaseVersion === (candidateTransition ? '1.0.19' : '1.0.18')) || (!publishedSuccessor && (development.publicVersion !== '1.0.18' || development.developmentTargetVersion !== '1.0.19')) || !/^M[78]-(?:[1-9]|[1-9]\d)-/.test(development.currentStage) || (successorTransition ? !development.binaryVersionTransition.startsWith(`v${development.runtimeBaseVersion}-`) : candidateTransition ? !development.binaryVersionTransition.startsWith('v1.0.19-') : development.binaryVersionTransition !== 'v1.0.18-release-and-managed-updater-closed') || development.releaseCandidate) fail('M7 successor development handoff drift')
