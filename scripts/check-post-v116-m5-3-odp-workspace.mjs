...
if (![`${policy.selectedNextStage.id}-${policy.selectedNextStage.name}`, 'M5-5-v1.0.17-atomic-version-transition-and-candidate-packaging'].includes(development.currentStage)) fail('development handoff has not progressed from M5-4')
