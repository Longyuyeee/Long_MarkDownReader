...
if (community.currentStatus !== 'v1.0.19-community-release-published' || !community.releaseCandidate || !community.gates?.githubReleasePublished || community.release?.databaseId !== policy.releaseDatabaseId || community.nextAction !== 'execute-m7-8-v1.0.18-to-v1.0.19-managed-updater-observation') fail('M7-7 community published state drift')
if (development.publicVersion !== '1.0.19' || development.publicTag !== policy.tag || development.publicTagCommit !== policy.candidateSourceCommit || development.currentStage !== 'M7-8-v1.0.18-to-v1.0.19-managed-updater-observation' || development.binaryVersionTransition !== 'v1.0.19-public-release-published') fail('M7-7 development handoff drift')
