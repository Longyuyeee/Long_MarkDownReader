...
if (policy.status !== 'local-comparison-receipt-review-source-validated-installed-acceptance-next' || policy.nextStage !== 'G15F-installed-local-receipt-review-acceptance') failures.push('G15F stage boundary drift')
...
console.log('G15F local comparison receipt review passed: strict aggregate-only validation, in-app review, production build, and Rust regression are complete without retaining paths or uploading receipts; installed acceptance remains pending.')
