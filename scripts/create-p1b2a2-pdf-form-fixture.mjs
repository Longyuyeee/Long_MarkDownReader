...
objects.set(9, stream('q 0.96 g 0 0 248 30 re f 0 G 0 0 248 30 re S BT /Helv 10 Tf 6 10 Td (Alice Example) Tj ET Q'))
objects.set(10, stream('q 1 g 0 0 20 20 re f 0 G 0 0 20 20 re S Q'))
objects.set(11, stream('q 1 g 0 0 20 20 re f 0 G 0 0 20 20 re S 2 w 4 10 m 8 5 l 16 16 l S Q'))
