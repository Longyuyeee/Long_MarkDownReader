...
const syntaxTheme = HighlightStyle.define([
  ...
  { tag: [tags.string, tags.special(tags.string), tags.docString], color: 'var(--code-editor-string)' },
  { tag: tags.regexp, color: 'var(--code-editor-regexp)' },
  { tag: tags.escape, color: 'var(--code-editor-escape)', fontWeight: '700' },
  { tag: [tags.number, tags.integer, tags.float], color: 'var(--code-editor-number)' },
  { tag: [tags.bool, tags.null, tags.atom, tags.unit], color: 'var(--code-editor-constant)', fontWeight: '600' },
  ...
  { tag: tags.propertyName, color: 'var(--code-editor-property)' },
  { tag: tags.tagName, color: 'var(--code-editor-tag)', fontWeight: '650' },
  { tag: tags.attributeName, color: 'var(--code-editor-attribute)' },
  { tag: [tags.typeName, tags.className, tags.namespace], color: 'var(--code-editor-type)', fontWeight: '600' },
  { tag: tags.operator, color: 'var(--code-editor-operator)' },
  { tag: [tags.punctuation, tags.separator, tags.bracket, tags.angleBracket], color: 'var(--code-editor-punctuation)' },
  { tag: [tags.meta, tags.documentMeta, tags.annotation, tags.processingInstruction, tags.macroName], color: 'var(--code-editor-meta)' },
