...
export type ExternalFilePolicy = 'none' | 'import' | 'preview' | 'edit'
...
export const isExternallyOpenable = (path: string) => {
  const policy = findFileFormat(path)?.externalPolicy
  return policy === 'edit' || policy === 'preview'
}
