...
export type EditorRouteName = 'LibraryMode' | 'TextEditor' | 'JsonEditor' | 'YamlEditor' | 'XmlEditor' | 'TomlEditor' | 'LogViewer' | 'DocxEditor' | 'OdtReader' | 'PptxReader' | 'Canvas' | 'Pdf' | 'Table' | 'Workbook' | 'Diagram' | 'MindMap'
