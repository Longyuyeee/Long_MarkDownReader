...
.page-jump { height: 32px; display: flex; align-items: center; gap: 6px; padding: 0 8px; border: 1px solid rgba(0,0,0,.09); border-radius: 7px; color: var(--theme-text-secondary); background: rgba(0,0,0,.025); font-size: var(--text-compact); }
...
.annotation-alert { margin-bottom: 8px; padding: 8px; border: 1px solid rgba(220,76,62,.24); border-radius: 7px; color: #b83e34; background: rgba(220,76,62,.08); font-size: var(--text-compact); line-height: 1.45; }
...
.delete-annotation { height: 28px; border: 1px solid rgba(220,76,62,.24); border-radius: 6px; color: #c4473c; background: rgba(220,76,62,.06); cursor: pointer; font-size: var(--text-compact); }.delete-annotation:disabled,.annotation-colors button:disabled { cursor: default; opacity: .4; }
.annotation-save-state { margin-top: 10px; color: var(--theme-text-secondary); font-size: var(--text-compact); text-align: center; }.annotation-save-state.error { color: #c4473c; }
...
.ocr-progress { display: flex; flex-direction: column; gap: 6px; margin: 10px 0; padding: 9px; border-radius: 7px; background: rgba(0,0,0,.035); font-size: var(--text-compact); }.ocr-progress progress { width: 100%; accent-color: var(--theme-primary); }.ocr-progress small,.ocr-note { color: var(--theme-text-secondary); font-size: var(--text-compact); }
.ocr-page-list { display: flex; flex-direction: column; gap: 6px; }.ocr-page-list button { display: flex; flex-direction: column; gap: 5px; padding: 8px; border: 1px solid rgba(0,0,0,.08); border-radius: 7px; color: var(--theme-text); background: rgba(255,255,255,.4); cursor: pointer; text-align: left; }.ocr-page-list button > span { display: flex; justify-content: space-between; font-size: var(--text-compact); }.ocr-page-list i { color: var(--theme-primary); font-style: normal; }.ocr-page-list small { display: -webkit-box; overflow: hidden; color: var(--theme-text-secondary); font-size: var(--text-compact); line-height: 1.45; -webkit-box-orient: vertical; -webkit-line-clamp: 3; }
.page-plan-dirty { display: inline-flex; margin-left: 7px; padding: 2px 5px; border-radius: 999px; color: #9a5a00; background: #fff0c7; font-size: var(--text-compact); font-style: normal; font-weight: 650; vertical-align: 1px; }
...
.page-plan-saved { display: flex; flex-direction: column; align-items: flex-start; gap: 3px; margin-bottom: 8px; padding: 7px; border: 1px solid rgba(43,125,78,.22); border-radius: 7px; color: #2b6f49; background: rgba(43,125,78,.07); }.page-plan-saved strong { font-size: var(--text-compact); }.page-plan-saved span { color: inherit; font-size: var(--text-compact); }
.page-plan-summary strong { font-size: 11px; }.page-plan-summary span { color: var(--theme-primary); font-size: var(--text-compact); }
.pdf-merge-panel,.pdf-insert-panel { display: grid; gap: 6px; margin-top: 8px; padding: 8px 0; border-top: 1px solid rgba(0,0,0,.08); border-bottom: 1px solid rgba(0,0,0,.08); }
...
.pdf-merge-add { display: grid; grid-template-columns: minmax(0,1fr) auto 30px; gap: 4px; }.pdf-merge-add input { min-width: 0; height: 28px; box-sizing: border-box; padding: 0 7px; border: 1px solid rgba(0,0,0,.12); border-radius: 5px; outline: 0; color: var(--theme-text); background: var(--theme-card); font-size: var(--text-compact); }.pdf-merge-add input:focus { border-color: rgba(var(--theme-primary-rgb),.45); }.pdf-merge-add button { height: 28px; padding: 0 8px; border: 1px solid rgba(var(--theme-primary-rgb),.25); border-radius: 5px; color: var(--theme-primary); background: rgba(var(--theme-primary-rgb),.06); cursor: pointer; font-size: var(--text-compact); font-weight: 650; }.pdf-merge-add button:disabled { cursor: default; opacity: .4; }.pdf-merge-add .pdf-merge-pick { display: grid; width: 30px; padding: 0; place-items: center; }
.pdf-merge-panel > small,.pdf-insert-panel > small { color: var(--theme-text-secondary); font-size: var(--text-compact); line-height: 1.4; }.pdf-merge-error { color: #a03f34 !important; }
.pdf-insert-source { display: grid; grid-template-columns: minmax(0,1fr) 24px; align-items: center; gap: 4px; min-height: 27px; padding-left: 7px; border-left: 2px solid var(--theme-primary); background: rgba(0,0,0,.025); }.pdf-insert-source span { overflow: hidden; color: var(--theme-text); text-overflow: ellipsis; white-space: nowrap; }.pdf-insert-source button { width: 21px; height: 21px; padding: 0; border: 1px solid rgba(0,0,0,.08); border-radius: 4px; color: var(--theme-text-secondary); background: var(--theme-card); cursor: pointer; }
.pdf-insert-range { display: grid; gap: 4px; }.pdf-insert-range span,.pdf-insert-position label span { color: var(--theme-text); font-size: var(--text-compact); font-weight: 650; }.pdf-insert-range input,.pdf-insert-position input { width: 100%; height: 27px; box-sizing: border-box; padding: 0 7px; border: 1px solid rgba(0,0,0,.12); border-radius: 5px; outline: 0; color: var(--theme-text); background: var(--theme-card); font-size: var(--text-compact); }.pdf-insert-range input:focus,.pdf-insert-position input:focus { border-color: rgba(var(--theme-primary-rgb),.45); }
.pdf-insert-position { display: grid; grid-template-columns: 62px minmax(0,1fr); align-items: end; gap: 5px; }.pdf-insert-position label { display: grid; gap: 4px; }.pdf-insert-segments { display: grid; grid-template-columns: repeat(3,1fr); height: 27px; }.pdf-insert-segments button { min-width: 0; padding: 0 4px; border: 1px solid rgba(0,0,0,.11); border-right-width: 0; color: var(--theme-text-secondary); background: var(--theme-card); cursor: pointer; font-size: var(--text-compact); }.pdf-insert-segments button:first-child { border-radius: 5px 0 0 5px; }.pdf-insert-segments button:last-child { border-right-width: 1px; border-radius: 0 5px 5px 0; }.pdf-insert-segments button.active { color: #fff; border-color: var(--theme-primary); background: var(--theme-primary); }
.pdf-merge-list { display: grid; gap: 3px; max-height: 128px; overflow: auto; }.pdf-merge-list article { display: grid; grid-template-columns: 18px minmax(0,1fr) auto auto; align-items: center; gap: 4px; min-height: 28px; padding: 0 4px; border-left: 2px solid transparent; background: rgba(0,0,0,.025); }.pdf-merge-list article.current { border-left-color: var(--theme-primary); }.pdf-merge-order { color: var(--theme-text-secondary); font-size: var(--text-compact); text-align: center; }.pdf-merge-name { overflow: hidden; color: var(--theme-text); font-size: var(--text-compact); text-overflow: ellipsis; white-space: nowrap; }.pdf-merge-current { color: var(--theme-primary); font-size: var(--text-compact); font-weight: 650; }
.pdf-merge-actions { display: flex; gap: 2px; }.pdf-merge-actions button { width: 21px; height: 21px; padding: 0; border: 1px solid rgba(0,0,0,.08); border-radius: 4px; color: var(--theme-text-secondary); background: var(--theme-card); cursor: pointer; font-size: var(--text-compact); }.pdf-merge-actions button:disabled { cursor: default; opacity: .28; }
...
.pdf-merge-verification { display: flex; flex-direction: column; gap: 3px; padding: 7px; border-left: 2px solid #2f9b63; color: #2b6f49; background: rgba(43,125,78,.06); }.pdf-merge-verification.blocked { border-left-color: #b45d4f; color: #943f35; background: rgba(180,93,79,.06); }.pdf-merge-verification strong { font-size: var(--text-compact); }.pdf-merge-verification span,.pdf-merge-verification small { color: inherit; font-size: var(--text-compact); line-height: 1.4; }
.pdf-merge-save { display: grid; gap: 4px; margin-top: 4px; padding-top: 5px; border-top: 1px solid rgba(43,125,78,.16); }.pdf-merge-save input { width: 100%; height: 27px; box-sizing: border-box; padding: 0 7px; border: 1px solid rgba(0,0,0,.12); border-radius: 5px; outline: 0; color: var(--theme-text); background: var(--theme-card); font-size: var(--text-compact); }.pdf-merge-save button { min-height: 28px; border: 0; border-radius: 5px; color: #fff; background: var(--theme-primary); cursor: pointer; font-size: var(--text-compact); font-weight: 650; }.pdf-merge-save button:disabled { cursor: default; opacity: .42; }
...
.page-range-extract input { width: 100%; height: 28px; box-sizing: border-box; padding: 0 7px; border: 1px solid rgba(0,0,0,.12); border-radius: 5px; outline: 0; color: var(--theme-text); background: var(--theme-card); font-size: var(--text-compact); }.page-range-extract input:focus { border-color: rgba(var(--theme-primary-rgb),.45); }
...
.page-range-extract small { color: var(--theme-text-secondary); font-size: var(--text-compact); line-height: 1.4; }.page-range-extract .page-range-error { color: #a03f34; }
...
.page-plan-history button,.page-plan-actions button { min-height: 26px; padding: 3px 6px; border: 1px solid rgba(0,0,0,.1); border-radius: 5px; color: var(--theme-text-secondary); background: var(--theme-card); cursor: pointer; font-size: var(--text-compact); }
...
.page-plan-save { display: flex; flex-direction: column; gap: 5px; margin-top: 5px; padding-top: 6px; border-top: 1px solid rgba(43,125,78,.16); }.page-plan-save label { display: flex; flex-direction: column; gap: 3px; }.page-plan-save input { width: 100%; height: 28px; padding: 0 7px; box-sizing: border-box; border: 1px solid rgba(0,0,0,.12); border-radius: 5px; outline: 0; color: var(--theme-text); background: var(--theme-card); font-size: var(--text-compact); }.page-plan-save input:focus { border-color: rgba(var(--theme-primary-rgb),.45); }.page-plan-save button { min-height: 29px; border: 0; border-radius: 6px; color: #fff; background: var(--theme-primary); cursor: pointer; font-size: var(--text-compact); font-weight: 650; }.page-plan-save button:disabled { cursor: default; opacity: .42; }.page-plan-save > small { color: #a03f34; }
...
.page-plan-preview > span { max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.page-plan-preview > small { position: absolute; top: 10px; left: 10px; padding: 2px 4px; border-radius: 4px; color: #fff; background: rgba(20,42,67,.8); font-size: var(--text-compact); }
.page-plan-actions { display: flex; flex-direction: column; gap: 4px; }.page-plan-actions button { width: 34px; padding: 0; font-size: 12px; }.page-plan-actions button:last-child { color: #b34a40; font-size: var(--text-compact); }.page-plan-actions button.restore { color: #257747; }
.selection-annotation-tool { position: fixed; z-index: 50; height: 36px; display: flex; align-items: center; gap: 7px; padding: 0 8px; border: 1px solid rgba(0,0,0,.14); border-radius: 9px; color: #e8edf3; background: #252a31; box-shadow: 0 10px 30px rgba(0,0,0,.28); font-size: var(--text-compact); }
...
.area-mode-hint { position: fixed; right: 18px; bottom: 18px; z-index: 40; padding: 9px 13px; border: 1px solid rgba(0,122,255,.28); border-radius: 8px; color: #fff; background: rgba(20,42,67,.92); box-shadow: 0 6px 20px rgba(0,0,0,.2); font-size: var(--text-compact); }
