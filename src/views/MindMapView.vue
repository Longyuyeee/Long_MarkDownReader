...
const startNodePointer = (event: PointerEvent, id: string) => {
  ...
  toggleNodeSelection(id, event.ctrlKey || event.metaKey)
...
.mindmap-toolbar{min-height:48px;padding:7px 14px;overflow-x:auto;border-bottom:var(--theme-border);background:var(--theme-surface)}.mindmap-toolbar button{white-space:nowrap}.mindmap-toolbar button.active{color:#fff;border-color:var(--theme-primary);background:var(--theme-primary)}.mindmap-toolbar button.danger{color:#d64545}.mindmap-toolbar .icon-tool{width:34px;padding:0;display:grid;place-items:center}.mindmap-toolbar .zoom-readout{min-width:54px;padding-inline:5px;font-variant-numeric:tabular-nums}.divider{height:24px;border-left:var(--theme-border)}.tool-select{height:34px;display:flex;align-items:center;gap:6px;padding-left:9px;border:var(--theme-border);border-radius:8px;color:var(--theme-text-secondary);background:var(--theme-card);font-size:var(--text-compact)}.tool-select select{height:32px;padding:0 22px 0 2px;border:0;outline:0;color:var(--theme-text);background:transparent}.search-box{min-width:220px;margin-left:auto;display:flex;align-items:center;gap:6px;padding:0 10px;border:var(--theme-border);border-radius:8px;background:var(--theme-card)}.search-box input{width:180px;height:30px;border:0;outline:0;color:var(--theme-text);background:transparent}
