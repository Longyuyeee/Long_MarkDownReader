...
@container(max-width:650px){.mindmap-main{grid-template-columns:minmax(0,1fr)}.inspector{display:none}.header-main span,.statusbar span:last-child{display:none}.search-box{margin-left:0}.mindmap-toolbar{padding-inline:8px}}
</style>
