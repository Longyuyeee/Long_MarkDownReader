...
.knowledge-pulse { display: grid; gap: 8px; padding: 12px 0; border-bottom: var(--theme-border); }.pulse-heading { display: flex; align-items: baseline; justify-content: space-between; gap: 10px; }.pulse-heading>div { display: flex; align-items: baseline; gap: 6px; }.pulse-heading span,.pulse-heading small { color: var(--theme-text-secondary); font-size: 8px; }.pulse-heading strong { color: var(--theme-primary); font-size: 16px; }.pulse-track { height: 5px; overflow: hidden; border-radius: 999px; background: rgba(var(--theme-primary-rgb),.09); }.pulse-track i { display: block; height: 100%; border-radius: inherit; background: var(--theme-primary); transition: width .25s ease; }.pulse-types,.pulse-nodes { display: flex; flex-wrap: wrap; gap: 5px; }.pulse-types span { padding: 3px 5px; border-radius: 4px; color: var(--theme-text-secondary); background: rgba(var(--theme-primary-rgb),.055); font-size: 8px; }.pulse-types b { color: var(--theme-text); }.pulse-nodes button { max-width: 150px; display: inline-flex; align-items: center; gap: 5px; padding: 4px 6px; border: 1px solid rgba(var(--theme-primary-rgb),.16); border-radius: 999px; color: var(--theme-primary); background: transparent; cursor: pointer; font-size: 8px; }.pulse-nodes button:hover { background: rgba(var(--theme-primary-rgb),.07); }.pulse-nodes span { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.pulse-nodes b { min-width: 14px; color: var(--theme-text-secondary); }.pulse-empty { min-height: 30px; padding: 0 8px; border: 1px dashed rgba(var(--theme-primary-rgb),.24); border-radius: 5px; color: var(--theme-primary); background: rgba(var(--theme-primary-rgb),.035); cursor: pointer; font-size: 8px; }.pulse-guidance { min-height: 42px; display: grid; grid-template-columns: minmax(0,1fr) 16px; align-items: center; gap: 8px; padding: 7px 8px; border: 1px solid rgba(var(--theme-primary-rgb),.18); border-radius: 5px; color: var(--theme-text); background: rgba(var(--theme-primary-rgb),.045); cursor: pointer; text-align: left; }.pulse-guidance:hover { border-color: rgba(var(--theme-primary-rgb),.35); }.pulse-guidance>span { min-width: 0; display: grid; gap: 2px; }.pulse-guidance b { font-size: 9px; }.pulse-guidance small { overflow: hidden; color: var(--theme-text-secondary); text-overflow: ellipsis; white-space: nowrap; font-size: 8px; }.pulse-guidance svg { width: 13px; color: var(--theme-primary); }.pulse-observation-action { justify-self: end; min-height: 26px; padding: 0 8px; border: 1px solid rgba(var(--theme-primary-rgb),.18); border-radius: 5px; color: var(--theme-primary); background: transparent; cursor: pointer; font-size: 8px; font-weight: 650; }.pulse-observation-action:hover { background: rgba(var(--theme-primary-rgb),.06); }
.pulse-isolation { display: grid; gap: 5px; padding: 7px 8px; border: 1px solid rgba(164,106,18,.18); border-radius: 5px; background: rgba(164,106,18,.045); }.pulse-isolation>div:first-child { display: flex; align-items: baseline; justify-content: space-between; gap: 8px; }.pulse-isolation>div:first-child span { color: #a46a12; font-size: 8px; font-weight: 750; }.pulse-isolation>div:first-child small { color: var(--theme-text-secondary); font-size: 8px; }.pulse-isolation>div:last-child { display: grid; grid-template-columns: repeat(2,minmax(0,1fr)); gap: 4px; }.pulse-isolation button { min-width: 0; min-height: 27px; display: grid; grid-template-columns: minmax(0,1fr) auto 12px; align-items: center; gap: 5px; padding: 3px 5px; border: 1px solid rgba(164,106,18,.15); border-radius: 4px; color: var(--theme-text); background: var(--theme-surface); cursor: pointer; text-align: left; }.pulse-isolation button:hover { border-color: rgba(164,106,18,.38); background: rgba(164,106,18,.06); }.pulse-isolation button span { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 8px; }.pulse-isolation button small { color: var(--theme-text-secondary); font-size: 7px; }.pulse-isolation button svg { width: 10px; color: #a46a12; }
