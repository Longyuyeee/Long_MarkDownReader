...
.workspace-alert { min-height: 38px; display: flex; align-items: center; gap: 8px; padding: 0 10px; color: #a64d23; border-bottom: 1px solid rgba(166,77,35,.25); font-size: var(--text-compact); }.workspace-alert svg { width: 14px; }.workspace-alert span { flex: 1; }.workspace-alert button,.text-command { border: 0; color: var(--theme-primary); background: transparent; cursor: pointer; font-size: var(--text-compact); }
