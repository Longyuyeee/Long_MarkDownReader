...
.workspace-alert { min-height: 38px; display: flex; align-items: center; gap: 8px; padding: 0 10px; color: var(--status-warning); border-bottom: 1px solid var(--status-warning-border); background: var(--status-warning-bg); font-size: var(--text-compact); }.workspace-alert svg { width: 14px; }.workspace-alert span { flex: 1; }.workspace-alert button,.text-command { border: 0; color: var(--theme-primary); background: transparent; cursor: pointer; font-size: var(--text-compact); }
