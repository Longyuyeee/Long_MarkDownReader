...
.alignment-guide span { position: absolute; padding: 2px 5px; border-radius: 999px; background: var(--theme-primary); color: white; font-size: 9px; font-weight: 700; line-height: 1.3; white-space: nowrap; }
...
.inspector-header { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; }.inspector-header > div { min-width: 0; display: grid; gap: 2px; }.inspector-header strong { font-size: 14px; }.inspector-header span { overflow: hidden; color: var(--theme-text-secondary); font-size: 10px; text-overflow: ellipsis; white-space: nowrap; }.inspector-header button { width: 27px; height: 27px; flex: 0 0 auto; border: 0; border-radius: 7px; background: transparent; color: var(--theme-text-secondary); cursor: pointer; font-size: 18px; }.inspector-header button:hover { background: color-mix(in srgb, var(--theme-primary) 10%, transparent); color: var(--theme-primary); }
.inspector-field { display: grid; gap: 5px; min-width: 0; }.inspector-field > span { color: var(--theme-text-secondary); font-size: 10px; font-weight: 700; }.inspector-field input:not([type="color"]), .inspector-field select { width: 100%; height: 33px; box-sizing: border-box; padding: 0 9px; border: var(--theme-border); border-radius: 8px; outline: 0; background: var(--theme-bg); color: var(--theme-text); font: inherit; font-size: 12px; }.inspector-field input:focus, .inspector-field select:focus { border-color: var(--theme-primary); box-shadow: 0 0 0 2px color-mix(in srgb, var(--theme-primary) 12%, transparent); }.side-fields { display: grid; grid-template-columns: 1fr 1fr; gap: 9px; }
