...
.queue-heading>div { display: grid; gap: 3px; }.queue-heading span { color: var(--theme-primary); font-size: var(--text-compact); font-weight: 800; }.queue-heading h2 { margin: 0; font-size: 14px; letter-spacing: 0; }.queue-heading p { margin: 3px 0 0; color: var(--theme-text-secondary); font-size: var(--text-compact); }
.queue-columns { display: grid; grid-template-columns: repeat(2,minmax(0,1fr)); gap: 32px; }.queue-column { min-width: 0; }
.column-title { min-height: 36px; display: grid; grid-template-columns: 20px minmax(0,1fr) auto; align-items: center; gap: 7px; border-bottom: var(--theme-border); }.column-title svg { width: 14px; color: var(--theme-primary); }.column-title strong { font-size: var(--text-compact); }.column-title span { color: var(--theme-text-secondary); font-size: var(--text-compact); }
.duplicate-group { padding: 10px 0 4px; border-bottom: var(--theme-border); }.group-meta { display: flex; justify-content: space-between; gap: 10px; margin-bottom: 4px; }.group-meta strong { font-size: var(--text-compact); }.group-meta span { color: var(--theme-text-secondary); font-size: var(--text-compact); }
.duplicate-group button,.annotation-list button { width: 100%; min-height: 42px; display: grid; grid-template-columns: minmax(0,1fr) 16px; align-items: center; gap: 8px; padding: 5px 6px; border: 0; color: var(--theme-text); background: transparent; cursor: pointer; text-align: left; }.duplicate-group button:hover,.annotation-list button:hover { color: var(--theme-primary); background: rgba(var(--theme-primary-rgb),.045); }.duplicate-group button>span,.annotation-list button>span { min-width: 0; display: grid; gap: 3px; }.duplicate-group button strong,.annotation-list button strong,.duplicate-group button small,.annotation-list button small { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.duplicate-group button strong,.annotation-list button strong { font-size: var(--text-compact); }.duplicate-group button small,.annotation-list button small { color: var(--theme-text-secondary); font-size: var(--text-compact); }.duplicate-group button svg,.annotation-list button svg { width: 12px; color: var(--theme-text-secondary); }
.annotation-list { display: grid; }.annotation-list button { border-bottom: var(--theme-border); }
.queue-empty { min-height: 82px; display: grid; place-items: center; margin: 0; color: var(--theme-text-secondary); font-size: var(--text-compact); }
.queue-alert,.queue-limit { min-height: 38px; display: flex; align-items: center; gap: 7px; margin: 0; color: #a64d23; font-size: var(--text-compact); }.queue-alert { border-bottom: 1px solid rgba(166,77,35,.25); }.queue-alert svg,.queue-limit svg { width: 13px; }.queue-limit { min-height: 32px; }
