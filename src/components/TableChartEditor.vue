...
.chart-settings header { display: flex; flex-direction: column; margin-bottom: 17px; }.chart-settings header strong { font-size: 13px; }.chart-settings header small,.chart-settings footer { color: var(--theme-text-secondary); font-size: var(--text-compact); }
.chart-settings section { margin-bottom: 20px; }.chart-settings section > b { display: block; margin-bottom: 8px; color: var(--theme-text-secondary); font-size: var(--text-compact); font-weight: 600; letter-spacing: .08em; text-transform: uppercase; }
.chart-types { display: grid; grid-template-columns: 1fr 1fr; gap: 6px; }.chart-types button { height: 36px; display: flex; align-items: center; gap: 7px; padding: 0 9px; border: 1px solid rgba(0,0,0,.09); border-radius: 7px; color: var(--theme-text-secondary); background: rgba(0,0,0,.025); cursor: pointer; font-size: var(--text-compact); }.chart-types button span { font-size: 15px; }.chart-types button.active { color: var(--theme-primary); border-color: rgba(var(--theme-primary-rgb),.45); background: rgba(var(--theme-primary-rgb),.08); }
.field-settings { display: flex; flex-direction: column; gap: 10px; }.field-settings > b { margin-bottom: -2px !important; }.field-settings label { display: flex; flex-direction: column; gap: 4px; color: var(--theme-text-secondary); font-size: var(--text-compact); }.field-settings select { width: 100%; height: 30px; padding: 0 7px; border: 1px solid rgba(0,0,0,.1); border-radius: 6px; outline: 0; color: var(--theme-text); background: var(--theme-card); font-size: var(--text-compact); }.field-settings select:focus { border-color: var(--theme-primary); }
...
.chart-empty { display: flex; flex-direction: column; align-items: center; gap: 7px; color: var(--theme-text-secondary); font-size: var(--text-compact); }.chart-empty strong { color: var(--theme-text); font-size: 13px; }
.grid-lines line { stroke: rgba(0,0,0,.07); }.grid-lines text,.x-labels text,.legend text,.pie-caption { fill: var(--theme-text-secondary); font-size: var(--text-compact); }.axis { stroke: rgba(0,0,0,.24); stroke-width: 1; }.axis-title { fill: var(--theme-text); font-size: 11px; font-weight: 600; }.legend text { fill: var(--theme-text); }.pie-total { fill: var(--theme-text); font-size: 20px; font-weight: 700; }.pie-caption { font-size: var(--text-compact); }
.data-label { fill: var(--theme-text); font-size: var(--text-compact); font-weight: 600; paint-order: stroke; stroke: var(--theme-card); stroke-width: 3px; stroke-linejoin: round; pointer-events: none; }
