...
.community-entry { min-height: 26px; padding: 0 9px; border: 1px solid rgba(var(--theme-primary-rgb),.2); border-radius: 6px; color: var(--theme-text); background: rgba(var(--theme-primary-rgb),.04); cursor: pointer; font-size: var(--text-compact); font-weight: 700; white-space: nowrap; }.community-entry.active { color: var(--theme-primary); border-color: rgba(var(--theme-primary-rgb),.42); background: rgba(var(--theme-primary-rgb),.1); }
.graph-community-panel { position: absolute; z-index: 10; top: 126px; right: 16px; width: min(380px, calc(100% - 32px)); max-height: min(520px, calc(100% - 160px)); display: grid; gap: 8px; padding: 10px; overflow: auto; box-sizing: border-box; border: 1px solid rgba(var(--theme-primary-rgb),.28); border-radius: 8px; color: var(--theme-text); background: color-mix(in srgb,var(--theme-card) 96%,transparent); box-shadow: var(--workspace-shadow); backdrop-filter: blur(16px); }.graph-community-panel > header { display: flex; align-items: start; justify-content: space-between; gap: 8px; }.graph-community-panel > header div { min-width: 0; display: grid; gap: 2px; }.graph-community-panel > header strong { font-size: 12px; }.graph-community-panel > header span,.graph-community-panel > p { margin: 0; color: var(--theme-text-secondary); font-size: var(--text-compact); line-height: 1.45; }.graph-community-panel > header button { width: 24px; height: 24px; flex: none; border: 0; color: var(--theme-text-secondary); background: transparent; cursor: pointer; font-size: 17px; }.community-return { min-height: 28px; border: 1px solid rgba(var(--theme-primary-rgb),.24); border-radius: 6px; color: var(--theme-primary); background: rgba(var(--theme-primary-rgb),.07); cursor: pointer; font-size: var(--text-compact); font-weight: 700; }.graph-community-list { display: grid; gap: 6px; }.graph-community-card { min-width: 0; display: grid; gap: 4px; padding: 8px; border: 1px solid var(--workspace-border-color); border-radius: 6px; color: var(--theme-text); background: var(--workspace-control-bg); text-align: left; cursor: pointer; }.graph-community-card:hover,.graph-community-card.active { border-color: rgba(var(--theme-primary-rgb),.44); background: rgba(var(--theme-primary-rgb),.09); }.graph-community-card > span:first-child { min-width: 0; display: flex; align-items: baseline; justify-content: space-between; gap: 8px; }.graph-community-card strong { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 11px; }.graph-community-card small,.community-representatives,.community-types { overflow: hidden; color: var(--theme-text-secondary); text-overflow: ellipsis; white-space: nowrap; font-size: var(--text-compact); }.community-types { color: var(--theme-primary); }.community-focus-banner { position: absolute; z-index: 7; top: 126px; left: 16px; max-width: min(620px, calc(100% - 32px)); min-height: 34px; display: flex; align-items: center; gap: 10px; padding: 5px 7px 5px 11px; box-sizing: border-box; border: 1px solid rgba(var(--theme-primary-rgb),.28); border-radius: 8px; color: var(--theme-text); background: color-mix(in srgb,var(--theme-card) 95%,transparent); box-shadow: var(--workspace-shadow-sm); backdrop-filter: blur(14px); font-size: var(--text-compact); }.community-focus-banner span { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.community-focus-banner button { flex: none; min-height: 24px; padding: 0 8px; border: 1px solid rgba(var(--theme-primary-rgb),.24); border-radius: 5px; color: var(--theme-primary); background: rgba(var(--theme-primary-rgb),.07); cursor: pointer; font-size: var(--text-compact); font-weight: 700; }.community-focus-active :deep(.graph-semantic-legend) { top: 170px; }
.graph-selection-history-panel { position: absolute; z-index: 10; top: 126px; right: 16px; width: min(340px,calc(100% - 32px)); max-height: min(500px,calc(100% - 160px)); display: grid; gap: 8px; padding: 10px; overflow: auto; box-sizing: border-box; border: 1px solid rgba(var(--theme-primary-rgb),.28); border-radius: 8px; color: var(--theme-text); background: color-mix(in srgb,var(--theme-card) 97%,transparent); box-shadow: var(--workspace-shadow); backdrop-filter: blur(16px); }.graph-selection-history-panel > header { display: flex; align-items: start; justify-content: space-between; gap: 8px; }.graph-selection-history-panel > header div { min-width: 0; display: grid; gap: 2px; }.graph-selection-history-panel > header strong { font-size: 12px; }.graph-selection-history-panel > header span { color: var(--theme-text-secondary); font-size: var(--text-compact); }.graph-selection-history-panel > header button { width: 24px; height: 24px; flex: none; border: 0; color: var(--theme-text-secondary); background: transparent; cursor: pointer; font-size: 17px; }.selection-history-controls { display: grid; grid-template-columns: 1fr 1fr; gap: 6px; }.selection-history-controls button,.graph-selection-history-panel ol button { min-height: 28px; border: 1px solid rgba(var(--theme-primary-rgb),.2); border-radius: 6px; color: var(--theme-primary); background: rgba(var(--theme-primary-rgb),.06); cursor: pointer; font-size: var(--text-compact); }.selection-history-controls button:disabled { opacity: .4; cursor: not-allowed; }.graph-selection-history-panel ol { display: grid; gap: 5px; margin: 0; padding: 0; list-style: none; }.graph-selection-history-panel ol button { width: 100%; min-width: 0; display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 7px 8px; color: var(--theme-text); text-align: left; }.graph-selection-history-panel ol button.active { border-color: rgba(var(--theme-primary-rgb),.5); background: rgba(var(--theme-primary-rgb),.12); }.graph-selection-history-panel ol strong { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: var(--text-compact); }.graph-selection-history-panel ol span { flex: none; color: var(--theme-text-secondary); font-size: var(--text-compact); }
.graph-comparison-panel { position: absolute; z-index: 11; top: 126px; left: 16px; right: 16px; max-width: 980px; max-height: min(590px, calc(100% - 160px)); display: grid; gap: 8px; padding: 9px 36px 10px 10px; overflow: auto; box-sizing: border-box; border: 1px solid rgba(var(--theme-primary-rgb),.28); border-radius: 8px; color: var(--theme-text); background: color-mix(in srgb,var(--theme-card) 97%,transparent); box-shadow: var(--workspace-shadow); backdrop-filter: blur(16px); }.graph-comparison-fields { display: grid; grid-template-columns: minmax(130px,1fr) auto minmax(130px,1fr) auto; align-items: center; gap: 7px; }.graph-comparison-fields select { min-width: 0; height: 28px; border: 1px solid var(--workspace-border-color); border-radius: 5px; color: var(--theme-text); background: var(--workspace-control-bg); font-size: var(--text-compact); }.graph-comparison-fields > span { color: var(--theme-text-secondary); font-size: var(--text-compact); }.graph-comparison-fields button,.graph-comparison-neighbors button,.graph-comparison-mentions button,.graph-comparison-structural button { min-height: 28px; padding: 0 9px; border: 1px solid rgba(var(--theme-primary-rgb),.24); border-radius: 5px; color: var(--theme-primary); background: rgba(var(--theme-primary-rgb),.07); cursor: pointer; font-size: var(--text-compact); font-weight: 700; }.graph-comparison-fields button:disabled { opacity: .45; cursor: not-allowed; }.graph-comparison-summary { display: grid; grid-template-columns: minmax(0,1fr) auto minmax(0,1fr); align-items: stretch; gap: 7px; }.graph-comparison-summary article,.graph-comparison-summary > div { min-width: 0; display: grid; gap: 3px; padding: 7px; border: 1px solid var(--workspace-border-color); border-radius: 6px; background: var(--workspace-control-bg); }.graph-comparison-summary > div { align-content: center; justify-items: center; color: var(--theme-primary); font-size: var(--text-compact); }.graph-comparison-summary strong { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 11px; }.graph-comparison-summary small,.graph-comparison-summary span { overflow: hidden; color: var(--theme-text-secondary); text-overflow: ellipsis; white-space: nowrap; font-size: var(--text-compact); }.graph-comparison-tags { display: grid; grid-template-columns: repeat(3,minmax(0,1fr)); gap: 7px; }.graph-comparison-tags span { min-width: 0; overflow: hidden; padding: 6px 7px; border-radius: 5px; color: var(--theme-text-secondary); background: rgba(var(--theme-primary-rgb),.05); text-overflow: ellipsis; white-space: nowrap; font-size: var(--text-compact); }.graph-comparison-tags b { margin-right: 6px; color: var(--theme-text); }.graph-comparison-neighbors { display: grid; grid-template-columns: repeat(3,minmax(0,1fr)); gap: 7px; }.graph-comparison-neighbors section { min-width: 0; display: grid; align-content: start; gap: 4px; padding: 7px; border: 1px solid var(--workspace-border-color); border-radius: 6px; }.graph-comparison-neighbors header,.graph-comparison-relations > header { display: flex; justify-content: space-between; color: var(--theme-text-secondary); font-size: var(--text-compact); }.graph-comparison-neighbors p,.graph-comparison-relations > p { margin: 0; color: var(--theme-text-secondary); font-size: var(--text-compact); }.graph-comparison-neighbors button { min-width: 0; display: flex; align-items: center; justify-content: space-between; gap: 6px; text-align: left; }.graph-comparison-neighbors button small { overflow: hidden; color: var(--theme-text-secondary); text-overflow: ellipsis; white-space: nowrap; }.graph-comparison-relations { display: grid; gap: 5px; }.graph-comparison-relations > article { display: grid; gap: 5px; padding: 7px; border: 1px solid var(--workspace-border-color); border-radius: 6px; background: color-mix(in srgb,var(--workspace-control-bg) 90%,transparent); }.graph-comparison-relations > article > header { min-width: 0; display: flex; align-items: center; gap: 8px; font-size: var(--text-compact); }.graph-comparison-relations > article > header span { overflow: hidden; color: var(--theme-text-secondary); text-overflow: ellipsis; white-space: nowrap; }.graph-comparison-mentions { display: grid; gap: 4px; }.graph-comparison-mentions > div,.graph-comparison-structural { min-width: 0; display: flex; align-items: center; justify-content: space-between; gap: 8px; padding-top: 4px; border-top: 1px dashed var(--workspace-border-color); color: var(--theme-text-secondary); font-size: var(--text-compact); }.graph-comparison-mentions span,.graph-comparison-structural span { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.graph-comparison-mentions code { color: var(--theme-primary); }.graph-comparison-close { position: absolute; z-index: 2; top: 5px; right: 7px; width: 24px; height: 24px; border: 0; color: var(--theme-text-secondary); background: var(--theme-card); cursor: pointer; font-size: 17px; }.graph-comparison-empty,.graph-comparison-invalid { margin: 0; color: var(--theme-text-secondary); font-size: var(--text-compact); }.graph-comparison-active :deep(.graph-semantic-legend) { visibility: hidden; }
...
.neighbor-focus-banner { position: absolute; z-index: 7; top: 126px; left: 16px; max-width: min(560px, calc(100% - 32px)); min-height: 34px; display: flex; align-items: center; gap: 8px; padding: 5px 7px 5px 11px; border: 1px solid rgba(var(--theme-primary-rgb),.28); border-radius: 8px; color: var(--theme-text); background: color-mix(in srgb, var(--theme-card) 95%, transparent); box-shadow: var(--workspace-shadow-sm); backdrop-filter: blur(14px); font-size: var(--text-compact); }.neighbor-focus-banner span { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.neighbor-focus-banner select { flex: none; height: 24px; border: 1px solid var(--workspace-border-color); border-radius: 5px; color: var(--theme-text); background: var(--workspace-control-bg); font-size: var(--text-compact); }.neighbor-focus-banner button { flex: none; min-height: 24px; padding: 0 8px; border: 1px solid rgba(var(--theme-primary-rgb),.24); border-radius: 5px; color: var(--theme-primary); background: rgba(var(--theme-primary-rgb),.07); cursor: pointer; font-size: var(--text-compact); font-weight: 700; }.neighbor-focus-active :deep(.graph-semantic-legend) { top: 170px; }
.graph-path-panel { position: absolute; z-index: 9; top: 126px; left: 16px; right: 16px; max-width: 760px; max-height: min(430px, calc(100% - 170px)); display: grid; gap: 6px; padding: 8px 36px 8px 10px; overflow: auto; box-sizing: border-box; border: 1px solid rgba(var(--theme-primary-rgb),.28); border-radius: 8px; color: var(--theme-text); background: color-mix(in srgb, var(--theme-card) 96%, transparent); box-shadow: var(--workspace-shadow-sm); backdrop-filter: blur(14px); }.graph-path-fields { display: grid; grid-template-columns: minmax(120px,1fr) auto minmax(120px,1fr) auto; align-items: center; gap: 7px; }.graph-path-fields select { min-width: 0; height: 28px; border: 1px solid var(--workspace-border-color); border-radius: 5px; color: var(--theme-text); background: var(--workspace-control-bg); font-size: var(--text-compact); }.graph-path-fields button,.graph-path-result button,.graph-path-evidence-list button { min-height: 28px; padding: 0 9px; border: 1px solid rgba(var(--theme-primary-rgb),.24); border-radius: 5px; color: var(--theme-primary); background: rgba(var(--theme-primary-rgb),.07); cursor: pointer; font-size: var(--text-compact); font-weight: 700; }.graph-path-fields button:disabled { opacity: .45; cursor: not-allowed; }.graph-path-result { min-width: 0; display: flex; align-items: center; gap: 8px; font-size: var(--text-compact); }.graph-path-result span { min-width: 0; overflow: hidden; color: var(--theme-text-secondary); text-overflow: ellipsis; white-space: nowrap; }.graph-path-result button { margin-left: auto; flex: none; }.graph-path-result.unreachable strong { color: var(--theme-warning, #d97706); }.graph-path-evidence-list { display: grid; gap: 6px; margin: 0; padding: 0; list-style: none; }.graph-path-evidence-edge { display: grid; gap: 6px; padding: 7px; border: 1px solid var(--workspace-border-color); border-radius: 6px; background: color-mix(in srgb,var(--workspace-control-bg) 90%,transparent); }.graph-path-evidence-edge > header { min-width: 0; display: grid; grid-template-columns: auto minmax(0,1fr) auto; align-items: center; gap: 7px; font-size: var(--text-compact); }.graph-path-evidence-edge > header span { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.graph-path-evidence-edge > header small { color: var(--theme-text-secondary); }.graph-path-mentions { display: grid; gap: 5px; }.graph-path-mentions article { min-width: 0; display: grid; grid-template-columns: minmax(0,1fr) auto; gap: 4px 8px; padding-top: 5px; border-top: 1px dashed var(--workspace-border-color); }.graph-path-mentions article > div { min-width: 0; display: flex; gap: 7px; font-size: var(--text-compact); }.graph-path-mentions article > div span { color: var(--theme-text-secondary); }.graph-path-mentions code,.graph-path-mentions p { grid-column: 1; min-width: 0; margin: 0; overflow: hidden; color: var(--theme-text-secondary); text-overflow: ellipsis; white-space: nowrap; font-size: var(--text-compact); }.graph-path-mentions code { color: var(--theme-primary); }.graph-path-mentions button { grid-column: 2; grid-row: 1 / 4; align-self: center; }.graph-path-structural-evidence { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding-top: 5px; border-top: 1px dashed var(--workspace-border-color); color: var(--theme-text-secondary); font-size: var(--text-compact); }.graph-path-structural-evidence button { flex: none; }.graph-path-close { position: sticky; z-index: 2; top: -2px; justify-self: end; width: 24px; height: 24px; margin-top: -36px; margin-right: -30px; border: 0; color: var(--theme-text-secondary); background: var(--theme-card); cursor: pointer; font-size: 17px; }.graph-path-active :deep(.graph-semantic-legend) { top: 214px; }
...
.graph-minimap header { height: 18px; display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 0 2px 4px; color: var(--theme-text-secondary); font-size: var(--text-compact); font-weight: 750; }
.graph-minimap header small { font-size: var(--text-compact); font-weight: 600; }
...
.graph-community-overview-nav > span { position: sticky; left: 0; flex: none; padding: 0 5px; color: var(--theme-text-secondary); background: var(--theme-card); font-size: var(--text-compact); font-weight: 750; }
