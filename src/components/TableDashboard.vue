...
.dashboard-toolbar { min-height: 48px; display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 8px 16px; box-sizing: border-box; border-bottom: 1px solid rgba(0,0,0,.07); background: var(--theme-card); }.dashboard-toolbar > div { display: flex; flex-direction: column; }.dashboard-toolbar strong { font-size: 12px; }.dashboard-toolbar span { color: var(--theme-text-secondary); font-size: 9px; }.dashboard-toolbar label { display: flex; gap: 6px; }.dashboard-toolbar select,.dashboard-toolbar button,.dashboard-card button { height: 28px; padding: 0 9px; border: 1px solid rgba(0,0,0,.1); border-radius: 6px; color: var(--theme-text); background: var(--theme-card); font-size: 9px; }.dashboard-toolbar select { min-width: 170px; }.dashboard-toolbar button { color: #fff; border-color: var(--theme-primary); background: var(--theme-primary); cursor: pointer; }.dashboard-toolbar button:disabled { opacity: .42; cursor: default; }
.dashboard-grid { display: grid; grid-template-columns: repeat(12, minmax(0, 1fr)); grid-auto-rows: 330px; gap: 12px; padding: 12px; }.dashboard-card { min-width: 0; display: grid; grid-template-rows: 38px minmax(0,1fr); overflow: hidden; border: 1px solid rgba(0,0,0,.08); border-radius: 11px; background: var(--theme-card); box-shadow: 0 5px 20px rgba(34,58,82,.07); }.dashboard-card > header { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 0 8px 0 10px; border-bottom: 1px solid rgba(0,0,0,.07); }.dashboard-card header > div { min-width: 0; display: flex; align-items: center; gap: 6px; }.dashboard-card strong { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 10px; }.dashboard-card small { color: var(--theme-text-secondary); font-size: 8px; }.drag-handle { color: var(--theme-text-secondary); cursor: grab; font-size: 14px; }.dashboard-card nav { display: flex; gap: 4px; }.dashboard-card button { height: 23px; padding: 0 6px; cursor: pointer; }.dashboard-card button.remove { color: #c44859; }
.dashboard-empty { flex: 1; display: grid; place-content: center; justify-items: center; padding: 30px; color: var(--theme-text-secondary); text-align: center; }.dashboard-empty strong { color: var(--theme-text); font-size: 14px; }.dashboard-empty p { max-width: 520px; font-size: 10px; line-height: 1.7; }
