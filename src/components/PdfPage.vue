...
.annotation-comment-marker { position: absolute; z-index: 4; width: 18px; height: 18px; display: grid; place-items: center; padding: 0; border: 2px solid #fff; border-radius: 50%; pointer-events: auto; cursor: pointer; color: #fff; background: #d59a00; box-shadow: 0 2px 6px rgba(0,0,0,.24); font-size: 7px; transform: translate(-50%,-50%); }.annotation-comment-marker.color-green { background: #159653; }.annotation-comment-marker.color-pink { background: #d83a83; }.annotation-comment-marker.color-blue { background: #1674d1; }.annotation-comment-marker.active { outline: 2px solid #ff6b21; }
