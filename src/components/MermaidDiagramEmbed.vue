...
.mermaid-embed > header { min-width: 0; display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 0 11px 0 14px; border-bottom: 1px solid rgba(0,0,0,.07); }.mermaid-embed header > div { min-width: 0; display: flex; flex-direction: column; }.mermaid-embed header strong { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 10px; }.mermaid-embed header span { color: var(--theme-text-secondary); font-size: 7px; }.mermaid-embed nav { display: flex; gap: 5px; }.mermaid-embed button { height: 25px; padding: 0 7px; border: 1px solid rgba(0,0,0,.09); border-radius: 5px; color: var(--theme-text-secondary); background: rgba(0,0,0,.025); cursor: pointer; font-size: 8px; }.mermaid-embed button:hover { color: var(--theme-primary); border-color: var(--theme-primary); }.mermaid-embed button:disabled { opacity: .45; }
