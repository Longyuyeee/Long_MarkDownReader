...
use commands::docx::{
    ...
    read_docx_document, read_external_docx_document, save_docx_patch_batch_copy,
    save_docx_patch_batch_source, save_docx_patch_copy, save_docx_patch_source,
};
use commands::drawio::{
...
use commands::pdf::{
    ...
    preview_pdf_redaction_copy, preview_pdf_watermark_copy, read_external_pdf_info,
    read_external_pdf_range, read_pdf_annotations, read_pdf_file, read_pdf_info, read_pdf_ocr,
    read_pdf_range, save_pdf_form_copy, save_pdf_form_text_copy, save_pdf_insert_copy,
    save_pdf_merge_copy, save_pdf_page_plan_copy, save_pdf_page_range_copy,
    save_pdf_redaction_copy, save_pdf_watermark_copy, write_pdf_annotations, write_pdf_ocr,
};
use commands::pptx::{
