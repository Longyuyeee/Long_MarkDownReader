...
fn augment_linked_data_fixture(path: &Path) -> Result<(), Box<dyn std::error::Error>> {
    ...
    entries.extend([
        ("xl/pivotTables/pivotTable1.xml".into(), zip::CompressionMethod::Deflated, br#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?><pivotTableDefinition xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" name="InventoryPivot" cacheId="1"/>"#.to_vec()),
        ("xl/pivotCache/pivotCacheDefinition1.xml".into(), zip::CompressionMethod::Deflated, br#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?><pivotCacheDefinition xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" refreshOnLoad="1"><cacheSource type="worksheet"><worksheetSource ref="A1:C3" sheet="Inventory"/></cacheSource></pivotCacheDefinition>"#.to_vec()),
